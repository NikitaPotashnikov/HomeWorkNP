$(function () {
  ...
  $('.countries__button').on('click', function (e) {
    ...
    else if ($(this).hasClass('ukraine') && $('.map').hasClass('ukraine')) {
      $(this).closest('.countries__item').addClass('countries__item--active')
      $('.ukraine').addClass('map--active')
    }
    else if ($(this).hasClass('turkey') && $('.map').hasClass('turkey')) {
      $(this).closest('.countries__item').addClass('countries__item--active')
      $('.turkey').addClass('map--active')
    }
    else if ($(this).hasClass('kazakhstan') && $('.map').hasClass('kazakhstan')) {
      $(this).closest('.countries__item').addClass('countries__item--active')
      $('.kazakhstan').addClass('map--active')
    }
    else if ($(this).hasClass('belarus') && $('.map').hasClass('belarus')) {
      $(this).closest('.countries__item').addClass('countries__item--active')
